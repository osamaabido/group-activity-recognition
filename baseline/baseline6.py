...
from models.Baseline6 import Person_Activity_Classifer , Group_Activity_Classifer_lstm
...
Config_file_path = File_Paths.Config_file_path_Baseline6

def main(person_activity_checkpoints):
    # Load configuration from file
    config_path = File_Paths.Config_file_path_Baseline6
    ...
    # Initialize model
    modela =  Person_Activity_Classifer(nums_classes=config['model']['num_classes']['person_activity'],
    )
