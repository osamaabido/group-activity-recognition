...
from models.Lstmperson import Person_Activity_Temporal
from models.Baseline7b import Group_Activity_Temporal
...
Config_file_path = File_Paths.Config_file_path_Baseline7b

def main(person_activity_checkpoints):
    # Load configuration from file
    config_path = File_Paths.Config_file_path_Baseline7b
    ...
    # Initialize model
    modela = Person_Activity_Temporal(
