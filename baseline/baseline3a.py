...
Config_file_path = File_Paths.Config_file_path_Baseline3a

def main():
    # Load configuration from file
    config_path = File_Paths.Config_file_path_Baseline3a
    ...
    # Initialize model
    model = Group_Activity_Classifer(num_classes=len(person_activity_labels))
