...
Config_file_path = File_Paths.Config_file_path_Baseline1

def main():
    # Load configuration from file
    config_path = File_Paths.Config_file_path_Baseline1
    ...
    # Initialize model
    model = Group_Activity_Classifer(num_classes=len(group_activity_labels))
