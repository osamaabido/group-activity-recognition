...
from models import Person_Activity_Temporal , Group_Activity_Temporal
from dataloader.DataLoader import Group , Person , person_activity_labels , group_activity_labels
...
class Baseline_8_Trainer():
    def __init__(self , config_file_path , Project_root , person_activity_checkpoints):
        ...
        self.exp_dir = os.path.join(
            f"{self.Project_root}/training/baseline8/{self.config['experiment']['output_dir']}",
