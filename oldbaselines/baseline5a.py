...
class LSTNPersonTrainer():
    ...
    def train(self , checkpoint_path=None):
        if checkpoint_path:
            ...
            self.exp_dir = "/kaggle/working/Group-Activity-Recognition/modeling/baseline 5/outputs/Baseline_B5_Step_A_V1_2024_12_22_09_43"
            self.logger = setup_logging(self.exp_dir)
